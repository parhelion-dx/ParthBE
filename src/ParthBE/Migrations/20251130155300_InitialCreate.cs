        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    profile_info = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_equipment_types_subjects_subject_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_equipment_requests_subjects_subject_id",
                        column: x => x.subject_id,
                        principalTable: "subjects",
                        principalColumn: "id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_equipment_requests_users_requested_by_user_id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    created_by_staff_id = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_slots_equipment_equipment_id",
                        column: x => x.equipment_id,
                        principalTable: "equipment",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_slots_users_created_by_staff_id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    student_user_id = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_bookings_users_student_user_id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_equipment_assigned_staff_id",
                table: "equipment",
                column: "assigned_staff_id");

            migrationBuilder.CreateIndex(
                name: "IX_equipment_inventory_number",
                table: "equipment",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_equipment_requests_requested_by_user_id",
                table: "equipment_requests",
                column: "requested_by_user_id");

            migrationBuilder.CreateIndex(
                name: "IX_equipment_requests_subject_id",
                table: "equipment_requests",
                column: "subject_id");

            migrationBuilder.CreateIndex(
                name: "IX_equipment_types_subject_id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_slots_created_by_staff_id",
                table: "slots",
                column: "created_by_staff_id");

            migrationBuilder.CreateIndex(
                name: "IX_slots_equipment_id_start_time",
                table: "slots",
                columns: new[] { "equipment_id", "start_time" },
                unique: true);
